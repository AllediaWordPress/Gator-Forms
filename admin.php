...
class PWebContact_Admin
{
	...
	function init()
	{
		...
		elseif ($task == 'edit' AND isset($_GET['id']))
		{
			...
			else
			{
				...
				wp_enqueue_script('pwebcontact_reliant_script', plugins_url('media/js/jquery.admin-reliant.js', __FILE__),
					array(
						'jquery'
					));
	...
	function configuration()
	{
		...
		<div class="wrap pweb-wrap pweb-view-<?php echo $this->view; ?>">
			...
			<p class="pweb-copyrights">
				Copyright &copy; 2015
				<a href="https://www.perfect-web.co/wordpress-plugins/contact-form" target="_blank"><strong>Perfect Web
						sp. z o.o.</strong></a>,
				All rights reserved.
				Distributed under
	...
	protected function _display_messages()
	{
		...
		{
			?>
			<div class="error pweb-clearfix"><p><strong><?php echo implode('<br>', $this->warnings); ?></strong></p>
			</div>
		<?php
		}
		...
		{
			?>
			<div class="updated pweb-clearfix"><p><strong><?php echo implode('<br>', $this->notifications); ?></strong>
				</p></div>
		<?php
		}
	}
	...
	protected function  _render_reliant_options()
	{
		/*** PRO START ***/
		//Create all the fields
		?>
		<div class="pweb-field pweb-field-select"><label for="pweb_fields_X_reliant" id="pweb_fields_X_reliant-lbl"
		                                                 class="pweb-has-tooltip"
		                                                 title="Select the desired field behaviour">Conditional
				display</label>

			<div class="pweb-field-control">
				<select name="fields[X][reliant_display]" id="pweb_fields_X_reliant_display">
					<option value="1">Show</option>
					<option value="2">Hide</option>
				</select>
				<span> if </span>
				<select name="fields[X][reliant_logic]" id="pweb_fields_X_reliant_logic">
			...
			<div class="pweb-repeatable-container">
				<div class="pweb-field-control pweb-repeatable-item">
					<select name="fields[X][reliant_conditions][Y][field]" id="pweb_fields_X_reliant_conditions_Y_field">
						<option value="alias">Name</option>
					</select>
					<select name="fields[X][reliant_conditions][Y][field_trigger]" id="pweb_fields_X_reliant_conditions_Y_field_trigger">
						<option value="1">equals to</option>
						<option value="2">does not equal to</option>
						<option value="3">contains</option>
						<option value="4">matches this regular expression</option>
					</select>
					<input type="text" name="fields[X][reliant_conditions][Y][field_value]" id="pweb_fields_X_reliant_conditions_Y_field_value" />
					<a href="#" class="pweb-repeatable-add"><i class="glyphicon glyphicon-plus"></i></a>
					<a href="#" class="pweb-repeatable-remove"><i class="glyphicon glyphicon-remove"></i></a>
				</div>
			</div>
		</div>
		<?php

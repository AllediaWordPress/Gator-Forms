...
?>
<div class="pweb-width-40">
    <h3 class="pweb-load-samples">
        <?php _e('Choose your colors', 'pwebcontact'); ?>
    </h3>
...
<div class="pweb-width-60">
    <h3 class="pweb-load-samples">
        <?php echo $this->_get_label(array(
            'group' => 'load',
            'name' => 'layout',
            'label' => 'Choose predefined layout'
        )); ?>
        ...
        <?php echo $this->_get_field_control(array(
            ...
            'name' => 'layout',
            'filter' => '\.jpg$',
            'directory' => 'media/layout_settings',
            'strip_ext' => true,
            'default' => 'Clean',
            'attributes' => array(
                'data-action' => admin_url( 'admin.php?page=pwebcontact&task=load_layout&ajax=1&_wpnonce='. wp_create_nonce('load-layout') )
            ),
            'options' => array(
                    array(
                        'name' => '- Select -',
    ...
    <div id="pweb-layout-preview">
        <img src="<?php echo plugins_url('pwebcontact/media/layout_settings/Clean.jpg'); ?>" alt="<?php _e('Layout preview', 'pwebcontact'); ?>">
        <p>
            <a href="#"><?php _e( 'Load settings for this layout', 'pwebcontact' ); ?></a>
        </p>
    </div>
</div>

<div id="pweb-dialog-layout" title="<?php esc_attr_e( 'Delete', 'pwebcontact' ); ?>" style="display:none">
    <p><?php _e( 'Are you sure you want to load settings for selected layout? It would change your current layout settings.', 'pwebcontact' ); ?></p>
</div>